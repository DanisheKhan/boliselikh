        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-white/60 transition-colors">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-white/60 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="text-white/60 text-sm transition-colors">Features</a></li>
              <li><a href="#pricing" className="text-white/60 text-sm transition-colors">Pricing</a></li>
              <li><a href="#security" className="text-white/60 text-sm transition-colors">Security</a></li>
            </ul>
          </div>
