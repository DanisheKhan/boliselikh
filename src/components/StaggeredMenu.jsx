        ...
        <header
          ...
          <button
            ...
            <span
              ...
              <span
                ref={plusHRef}
                className="sm-icon-line absolute left-1/2 top-1/2 w-4 h-0.5 bg-black rounded-0.5 -translate-x-1/2 -translate-y-1/2 will-change-transform" />
              <span
                ref={plusVRef}
                className="sm-icon-line sm-icon-line-v absolute left-1/2 top-1/2 w-4 h-0.5 bg-black rounded-0.5 -translate-x-1/2 -translate-y-1/2 will-change-transform" />
            </span>
          </button>
        </header>
