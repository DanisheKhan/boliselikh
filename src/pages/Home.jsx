...
function Home() {
  ...
  return (
    <div style={{ width: '100%', minHeight: '100vh', position: 'relative' }}>
      ...
      {/* StaggeredMenu */}
      <div style={{ position: 'fixed', top: 0, left: 0, right: 0, width: '100%', height: '100vh', zIndex: 50, overflow: 'hidden', pointerEvents: 'none' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#press" className="text-gray-400 hover:text-white text-sm transition-colors">Press</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#api" className="text-gray-400 hover:text-white text-sm transition-colors">API Reference</a></li>
                  <li><a href="#community" className="text-gray-400 hover:text-white text-sm transition-colors">Community</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#license" className="text-gray-400 hover:text-white text-sm transition-colors">License</a></li>
                </ul>
              </div>
            </div>
